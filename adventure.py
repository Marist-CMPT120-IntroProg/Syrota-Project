...
for place in marist_world:
    locale_object.append(Locale(name = place["name"], summary = place["summary"], details = place["details"]))
     
#Create a new World object 
marist_world = World(locale_list = locale_object, nav_list = marist_map)

#Create a new Player object 
player_1 = Player(world_map = marist_world)
